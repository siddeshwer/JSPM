...
<!--     </div> -->
    ...
    <main>
        ...
        <div class="slider-area position-relative">
            ...
            <div class="video-icon">
                <a class="popup-video btn-icon" href="https://www.youtube.com/watch?v=dDQuU7VLRJU" data-animation="bounceIn" data-delay=".4s"><i class="fas fa-play"></i></a>
            </div>
        </div>
        <!-- slider Area End-->
  ...
  <div>  <marquee style="color:red;font-size:20px;">
  <%while(rs.next()){ %>
*<img src="assets/img/logo/new.gif" style="height:50px;width:100px;"><%out.print(rs.getString(2)); %>&nbsp;
                ...
                <div class="row justify-content-between">
                    <div class="col-xl-6 col-lg-6 col-md-10">
                        <div class="about-caption mb-50">
                            ...
                            <div style="height:30px;width:300px;background-color:red;margin-left:600px;text-align:center;">Notice Board</div>
                            <div style="height:100px;width:400px;margin-left:600px;">
                            <%while(rs.next()){ %>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.jsp">Quality</a></h5>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.jsp">Reliablity</a></h5>
                                <p>We collect and analyze information about your general usage of the website, products, services, and courses.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.jsp">Experience</a></h5>
                                <p>We collect and analyze information about your general usage of the website, products, services, and courses.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.jsp">Manufacturing</a></h5>
                                <p>We collect and analyze information about your general usage of the website, products, services, and courses.</p>
                            </div>
                        </div>
                    </div>
